...
declare class UIDevice extends NSObject {
	...
	readonly pesdk_isTooOldForLensBlurPreview: boolean;
...
declare class UIImage extends NSObject implements NSItemProviderReading, NSItemProviderWriting, NSSecureCoding, UIAccessibilityIdentification, UIItemProviderPresentationSizeProviding {
	...
	readonly pesdk_normalizedImage: UIImage;
	...
	pesdk_downsampleWithMaxDimension(dimension: number): UIImage;

	pesdk_drawInRectWithContentMode(rect: CGRect, contentMode: UIViewContentMode): void;

	pesdk_imageWithTintColor(tint: UIColor): UIImage;

	pesdk_normalizedImageOfSize(size: CGSize): UIImage;

	pesdk_resizedImageToSizeInterpolationQuality(newSize: CGSize, quality: CGInterpolationQuality): UIImage;

	pesdk_resizedImageToSizeTransformDrawTransposedInterpolationQuality(newSize: CGSize, transform: CGAffineTransform, transpose: boolean, quality: CGInterpolationQuality): UIImage;
...
declare class UIViewController extends UIResponder implements NSCoding, NSExtensionRequestHandling, UIAppearanceContainer, UIContentContainer, UIFocusEnvironment, UIStateRestoring, UITraitEnvironment {
	...
	pesdk_didBecomeActiveTool(): void;

	pesdk_didResignActiveTool(): void;

	pesdk_willBecomeActiveTool(): void;

	pesdk_willResignActiveTool(): void;
